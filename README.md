...
3. **PurchaseOrder (PO):** Records high-level order metadata, total calculated amounts, and workflow status (`PENDING_APPROVAL`, `APPROVED`).
...
├── ai_agent.py          # LangChain ReAct agent logic & Gemini integration
...
git clone https://github.com/Prateek-Singh000/SAP-Mini-ERP-P2P-Agent.git
...
SAP_DATABASE_URL=hana+hdbcli://username:password@host:port
